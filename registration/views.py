    ...
    if request.method=='POST':
        ...
        if user is not None:
            ...
            if 'LoginBtn1' in request.POST:
                ...
                message = "Hi,"+ str(user.first_name)+", this is your OTP for logging into our system : " + str(otp) + ". Please login with fast minutes.\n Jai kumar\n jigyashu\n aman \n harshit"
                ...
                message = "Hi,"+ str(user.first_name)+", the QR for logging into our system is attached. Please login within fast minutes."
